Scope (_SB.PCI0.I2C3)
{
    Device (SKC2)
    {
        ...
        Field (\_SB.PCI0.I2C3.SKC2.GPOP, ByteAcc, NoLock, Preserve)
        {
            Connection
            (
        ...
        /* Set or clear GP4F GPIO */
        Method (CG4F, 1, Serialized)
        {
            GP4F = Arg0
        }

        /* Set or clear GP50 GPIO */
        Method (CG50, 1, Serialized)
        {
            GP50 = Arg0
        }
            ...
            Method (_ON, 0, Serialized) {
                ...
                If (LEqual (AVBL, 1)) {
                    If (LEqual (STA, 0)) {
                        ...
                        \_SB.PCI0.I2C3.SKC2.CLKE()
                        CLE1 = 1

                        // \_SB.PCI0.I2C3.SKC2.CG50(1)
                        /*
            ...
            Method (_OFF, 0, Serialized) {
                If (LEqual (AVBL, 1)) {
                    If (LEqual (STA, 1)) {
                        Sleep(2)
                        CLE1 = 0
                        \_SB.PCI0.I2C3.SKC2.CLKD()
                        Sleep(2)
                        // \_SB.PCI0.I2C3.SKC2.CG50(0)
                        Sleep(3)
                        VAX1 = 0
                        Sleep(1)
                        // \_SB.PCI0.I2C3.SKC2.CG4F(0)
                        Sleep(1)
                        VAX2 = 0
                        Sleep(1)
                        DOVD(0)

...
static const struct regval ov5693_global_regs[] = {
	{0x0103, 0x01},
	{0x3001, 0x0a},
	{0x3002, 0x80},
	{0x3006, 0x00},
...
static int __ov569x_start_stream(struct ov569x *ov569x)
{
	...
	case CHIP_ID_OV5693:
		ret = ov569x_write_array(ov569x->client, ov5693_global_regs);
		if (ret)
			return ret;
		break;
	case CHIP_ID_OV5695:
		ret = ov569x_write_array(ov569x->client, ov5695_global_regs);
		if (ret)
			return ret;
		break;
	}
